...
ipcMain.handle('bot:insight', (_e, symbol) => tradingbot.insight(symbol));
ipcMain.handle('bot:stats', () => tradingbot.botStats());
ipcMain.handle('notify:cfg', () => notifier.publicCfg());
ipcMain.handle('notify:setCfg', (_e, patch) => notifier.setCfg(patch));
ipcMain.handle('notify:test', () => notifier.test());
