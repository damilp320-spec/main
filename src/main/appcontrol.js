...
const SETTABLE = new Set(['effort', 'defaultModel', 'temperature', 'maxSteps', 'rag', 'constitution', 'voiceReplies', 'autoListen', 'notifications', 'taskConcurrency', 'musicService', 'toolRouting', 'modelRouting', 'selfVerify', 'visibleThinking', 'webAutomation', 'guiAutomation', 'operator', 'autoLearnSkills', 'duplexVoice', 'artifacts', 'quickAsk']);
