...
const BUNDLES = [
  ...
  { name: 'web', tools: ['web_search', 'http_get', 'open_url', 'open_website', 'web_search_open', 'learn_website'],
    kw: ['найди', 'поищи', 'интернет', 'сайт', 'ссылк', 'url', 'web', 'search', 'google', 'открой стран', 'новост', 'погод', 'курс', 'изучи сайт', 'обойди сайт', 'проиндексир'] },
