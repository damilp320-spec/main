...
const CATALOG = [
  ...
  },
  {
    ...
    size: '0.3 GB',
    ram: 8,
    tags: ['эмбеддинги', 'RAG', 'память'],
    desc: 'Модель эмбеддингов для RAG-памяти агентов и поиска по документам. Нужна для долгой памяти на векторах.',
    best: true
  },
  {
    ...
    size: '7.8 GB',
    ram: 16,
    tags: ['зрение', 'мультимодальная', 'UI-агент'],
    desc: 'Видит изображения и скриншоты экрана — для UI-агентов и компьютерного зрения.'
  },
  {
    id: 'moondream:1.8b',
    ...
    size: '1.7 GB',
    ram: 8,
    tags: ['зрение', 'лёгкая', 'UI-агент'],
    desc: 'Компактная модель компьютерного зрения — работает даже на слабом ПК.'
  }
];
